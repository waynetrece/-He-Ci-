...
目前主線是 HJ 報價單草案整理；`discussions/hj-quote-draft.md` 已更新為草案 v13 工作稿，參考馬亞既有報價單語氣，但依 HJ 架構重新撰寫設計與程式內容。v13 主案未稅 `$1,040,750`、含稅 `NT$ 1,092,788`，待 Wayne review 後才輸出正式客戶版。
