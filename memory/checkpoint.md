...
## 最新狀態：報價單草案 v10 工作稿已更新，待 Wayne review
...
- Front matter：`status: 草案v10`、`draftedAt: 2026-05-05`
- 依據：
  - `HJ網站客製需求表_1150422`
  ...
  - `富致科技報價單20240326.xls`
- v10 修訂重點：
  - 套馬亞既有報價單樣式，標題改為「馬亞科技報價單」+ 專案副標。
  - 設計區 CMS 6 頁收斂為 4 頁；設計小計 `$161,500`。
  - 程式明細加總對齊 `$879,000`，高複雜度集中在公版商品、購物車/訂單、會員、運費/材積、凌越 ERP。
...
1. Wayne review `discussions/hj-quote-draft.md` 的 v10 金額與模組拆法。
...
- 不要把 v10 草案直接當作已可發送客戶版；仍待 Wayne 最終 review。
