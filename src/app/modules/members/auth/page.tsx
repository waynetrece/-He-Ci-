...
const QUESTIONS = [
  {
    ...
    context:
      "目前畫面預設：① 註冊第一步先選會員類型 ② 個人會員填基本資料即可立即啟用 ③ 企業客戶填公司資料後標示「審核中」，由 HJ 業務人工確認 ERP 編號與分級後啟用。審核中可瀏覽公版商品、申請樣品；查看企業價、下單、私版報價需審核完成。",
  ...
  {
    no: "Q2",
    question: "LINE 在系統中是用來「快速登入／註冊」、「接收通知/客服綁定」，還是兩者都要支援？",
    context:
      "目前畫面預設：① 在 Auth 頁的「LINE 一鍵註冊」用來建立會員帳號 ② 登入後在「帳號設定」另設「LINE 帳號綁定」用來接收訂單／報價／出貨通知。兩者是不同功能，分頁呈現避免混淆。",
